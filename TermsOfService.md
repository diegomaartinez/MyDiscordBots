...
This Terms of Service Agreement (the "Agreement") is entered into between Diego Martínez ("Bot Owner") and the user ("User") of the Discord bot (the "Bot").
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of Spain. Any dispute arising under or in connection with this Agreement shall be resolved by arbitration in accordance with the rules of an arbitration provider.
